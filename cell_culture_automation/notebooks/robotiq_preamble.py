...
ROBOTIQ_PREAMBLE = "\n".join(
    [
        ...
        "",
        "def rq_init_comm_if_connected(gripper_sid=9, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_is_gripper_connected(gripper_sid=9, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_sid(gripper_sid=9, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_reset_and_activate(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + ", reset=False):",
        ...
        "end",
        "",
        "def rq_auto_release_open_and_wait(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_auto_release_close_and_wait(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_wait_autorelease_completed(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_move_and_wait(pos, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_wait_for_pos_request(pos, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_wait_for_object_detected(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "def rq_set_pos_spd_for(pos, speed, force, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_gripper_max_current_mA(current_mA, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_gripper_mode(mode, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_gripper_max_cur(current_mA, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_get_gripper_max_current_mA(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_get_gripper_max_cur(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "def rq_send_pos_spd_for(pos, speed, force, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_is_motion_complete(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_is_gripper_activated(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_is_object_detected(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_print_gripper_fault_code(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        + ", "
        + QUOTATION
        + "Priority Fault: Action delayed, initialization must be completed prior to action (0x05)"
        + QUOTATION
        + ")",
        ...
        + ", "
        + QUOTATION
        + "Priority Fault: The activation must be set prior to action (0x07)"
        + QUOTATION
        + ")",
        ...
        + ", "
        + QUOTATION
        + "Minor Fault: Automatic release in progress (0x0B)"
        + QUOTATION
        + ")",
        ...
        + ", "
        + QUOTATION
        + "Minor Fault: Overcurrent protection triggered (0x0E)"
        + QUOTATION
        + ")",
        ...
        + ", "
        + QUOTATION
        + "Major Fault: Automatic release completed (0x0F)"
        + QUOTATION
        + ")",
        "    else:",
        "	textmsg("
        ...
        "end",
        "",
        "def rq_print_gripper_num_cycles(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "	textmsg("
        + QUOTATION
        + "Gripper Cycle Number : "
        + QUOTATION
        + ", "
        + QUOTATION
        + "Number of cycles is unreachable."
        + QUOTATION
        + ")",
        "    else:",
        "	textmsg("
        ...
        "end",
        "",
        "def rq_print_gripper_driver_state(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_print_gripper_serial_number(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_print_gripper_firmware_version(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_print_gripper_driver_version(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "    textmsg("
        + QUOTATION
        + "Gripper Driver Version : "
        + QUOTATION
        + ", string_from_server)",
        "end",
        "",
        "def rq_print_gripper_probleme_connection(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_GTO_and_wait(value, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_var(var_name, var_value, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "",
        "",
        "def rq_get_var(var_name, nbr_bytes, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_is_object_validated(gripper_selected, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "############################################",
        "def rq_set_force_norm(force_norm, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_speed_norm(speed_norm, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_move_norm(pos_norm, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_move_and_wait_norm(pos_norm, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_set_pos_norm(pos_norm, gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_gripper_led_force_red(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_gripper_led_force_blue(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_gripper_led_force_green(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def rq_gripper_led_force_purple(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + "):",
        ...
        "end",
        "",
        "def clear_socket_buffer(gripper_socket="
        + QUOTATION
        + "1"
        + QUOTATION
        + ", read_timeout = 0.1):",
