...
int main(int argc, char* argv[])
{
	...
	*/
	...
	g_scenes.push_back(new Pouring("Pouring Scene 1", "../../data/Assembly1", "../../output/Assembly1"));
	...
	/*g_scenes.push_back(new Pouring("Pouring Scene 3", "../../data/goblet05.obj", "../../output/goblet05.text", 0.6f));
