...
dir_path = os.getcwd()
dir_path = "/media/karl/New Volume/documents/flex-110/flex/output/stopping_1deg"
filenames = glob.glob(dir_path+'/autogenerated*.text')
for file_name in filenames:
  data = open(file_name,'r')
  file_string = data.read() #entire file is one string, each line has \r\n
  line_ends = [m.start() for m in re.finditer('\r',file_string)]
  line_list = []
