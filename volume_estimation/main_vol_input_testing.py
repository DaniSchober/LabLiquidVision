...
from src.models_input_vol_testing.predict_full_pipeline import predict
...
def main():
    ...
    if args.mode == "train":
        ...
        import src.models_input_vol_testing.train_model
        ...
        print("Testing model")
        import src.models_input_vol_testing.test_model
