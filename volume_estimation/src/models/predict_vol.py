...
def predict(folder_path):
    ...
    vessel_depth_path = os.path.join(folder_path, "Input_EmptyVessel_Depth_segmented.npy")
    ...
    plt.axis("off")
    # add text
    plt.text(920, 150, "True liquid volume: {} ml".format(true_vol_liquid), color="black", fontsize=14)
    plt.text(920, 190, "True vessel volume: {} ml".format(true_vol_vessel), color="black", fontsize=14)
    plt.text(920, 230, "Predicted liquid volume: {} ml".format(int(vol[0][0].item())), color="black", fontsize=14)
    plt.text(920, 270, "Predicted vessel volume: {} ml".format(int(vol[0][1].item())), color="black", fontsize=14)
