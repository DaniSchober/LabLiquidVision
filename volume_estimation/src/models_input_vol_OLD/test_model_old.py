...
model.load_state_dict(torch.load("models/volume_model_input_vol_testing.pth"))
model.eval()
...
with torch.no_grad():
    ...
    plt.tight_layout()
    plt.savefig(output_folder_res + "/squared_error_liquid_vol_input.png", format="png", dpi=600)
    plt.show()
    ...
    plt.tight_layout()
    plt.savefig(output_folder_res + "/scatter_plot_vol_input.png", format="png", dpi=600)
    # show scatter plot
    plt.show()
