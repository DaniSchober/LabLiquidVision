...
from src.models_no_input_vol_testing.validate_model import validate
import math
#import wandb
...
def train(
    ...
    for i, data in enumerate(progress_bar):
        ...
        input1 = data["vessel_depth_scaled"].to(device)
        #print(input1.shape)
        #print(input1.mean())
        #print(input1)
        input2 = data["liquid_depth_scaled"].to(device)
        #print(input2.shape)
        #print(input2.mean())
        #print(input2)
    ...
    for batch_size_train in batch_sizes:
        for dropout_rate in dropout_rates:
            ...
            if rmse_valid < best_rmse:
                ...
                torch.save(model.state_dict(), "models/volume_model_testing.pth")

            # save final loss and rmse for this training run to txt file
            with open("results_no_input_vol_testing.txt", "a") as f:
