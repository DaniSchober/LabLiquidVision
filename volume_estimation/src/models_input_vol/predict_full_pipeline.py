...
from src.models_input_vol.model import VolumeNet


def predict_with_vol(image_path, predict_volume=False, save_segmentation=False, save_depth=False, vessel_volume=0):
